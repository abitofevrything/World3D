package me.abitofevrything.world3d.models.animatedModel;
...
public class AnimatedModel {
	...
	/**
	 * Creates an {@link AnimatedModel} without any joints or animation
	 * 
	 * @param model - The vao for this model
	 * @param texture - The texture for this model
	 */
	public AnimatedModel(Vao model, Texture texture) {
		this(model, texture, new Joint(0, "", new Matrix4f()), 0);
	}
	 ...
	 *            
	 * @throws NullPointerException - If this model does not have any joints ({@code null} as the root joint)
	 */
